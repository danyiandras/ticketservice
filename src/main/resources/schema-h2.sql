...
CREATE SEQUENCE "PUBLIC"."LICENCE_SEQ" START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE "PUBLIC"."MOVIE_SEQ" START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE "PUBLIC"."SCREENING_SEQ" START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE "PUBLIC"."SEAT_SEQ" START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE "PUBLIC"."THEATER_SEQ" START WITH 1 INCREMENT BY 1;
